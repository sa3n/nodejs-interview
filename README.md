...
<details>
    ...
    * при обращении к переменной до её объявленния: с let вызовет ReferenceError (переменная находится в TDZ), с var вернётся undefined
    * переменную можно повторно объявить с помощью var, повторное оьъявление с let вызовет SyntaxError 
